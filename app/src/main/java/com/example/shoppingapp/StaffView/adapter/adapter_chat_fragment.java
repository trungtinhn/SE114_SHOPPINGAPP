...
import com.example.shoppingapp.StaffView.activity.activity_specificchat;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;

public class adapter_chat_fragment extends RecyclerView.Adapter<adapter_chat_fragment.NoteViewHolder> implements Filterable {
    Context context;
    ArrayList<User> arrayList;
    ArrayList<User> arrayListOld;

    public adapter_chat_fragment(Context context, ArrayList<User> objects) {
    ...
    @NonNull
    @Override
    public adapter_chat_fragment.NoteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull NoteViewHolder noteViewHolder, int position) {
        ...
        noteViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(view.getContext(), activity_specificchat.class);
