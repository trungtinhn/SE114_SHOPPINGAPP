...
public class confirm_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_order_screen_oder ,container, false);
       RVparent= view.findViewById(R.id.RCV_confirm);
       setdata();
       // return view;
        return view;
    }
    ...
    private void setdata() {
        ...
        parentItemArrayList.add(new user_object("Thach Sang2","213123123",150000,R.drawable.anh1));
        parentItemArrayList.add(new user_object("Thach Sang3","213123123",150000,R.drawable.anh1));
